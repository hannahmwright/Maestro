...
interface ToolActivityBlockProps {
	log: WebRemoteLogEntry;
	expanded: boolean;
	onToggleExpanded: () => void;
}

export function ToolActivityBlock({ log, expanded, onToggleExpanded }: ToolActivityBlockProps) {
	...
	return (
		<div
			style={{
				...
				borderRadius: '12px',
				backgroundColor: `${colors.bgMain}96`,
				...
				{canToggleToolDetails && (
					<button
						...
						style={{
							...
							borderRadius: '999px',
							border: `1px solid ${colors.border}`,
							backgroundColor: `${colors.bgMain}80`,
							color: colors.textDim,
							cursor: 'pointer',
						}}
					...
					{collapsedSourceDomains.slice(0, 6).map((domain) => (
						<span
							...
							style={{
								padding: '3px 7px',
								borderRadius: '999px',
								backgroundColor: `${colors.bgMain}aa`,
								border: `1px solid ${colors.border}`,
								fontSize: '10px',
								color: colors.textDim,
							}}
													...
													{responseDomains.map((domain) => (
														<span
															...
															style={{
																padding: '3px 7px',
																borderRadius: '999px',
																backgroundColor: `${colors.bgSidebar}bb`,
																border: `1px solid ${colors.border}`,
																fontSize: '10px',
																color: colors.textDim,
															}}
