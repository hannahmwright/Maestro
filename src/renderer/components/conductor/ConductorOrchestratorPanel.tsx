	...
	return (
		...
		>
				...
				<div className="px-5 py-3 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
					<div className="text-[11px] uppercase tracking-wider mb-2" style={{ color: theme.colors.textDim }}>
						Quick asks
					</div>
							...
							<div key={message.id} className="flex justify-start">
								...
								>
									<div className="flex items-center gap-2 mb-2">
										...
										<span className="text-[11px] font-medium uppercase tracking-wide" style={{ color: theme.colors.textDim }}>
											Orchestrator
										</span>
									</div>
